...
const Settings = () => {
  ...
  const [profile, setProfile] = useState({
    ...
    email: user?.email || "member@teamhub.com",
      ...
      <div className="bg-white shadow-soft border-b border-gray-100">
        <div className="container mx-auto px-6 py-6">
          <div className="flex items-center space-x-4">
            <BackButton to="/team-member/dashboard" />
            <div>
              ...
              <div className="card">
                ...
                <div className="space-y-4">
                  ...
                  <ToggleSwitch
                    ...
                    onChange={(e) => handleNotificationUpdate("taskAssignments", e.target.checked)}
                  ...
                  <ToggleSwitch
                    ...
                    onChange={(e) => handleNotificationUpdate("teamMentions", e.target.checked)}
                    label="Team Mentions"
                  />
                  <ToggleSwitch
                    checked={notifications.deadlineAlerts}
                    onChange={(e) => handleNotificationUpdate("deadlineAlerts", e.target.checked)}
            ...
            {activeTab === "privacy" && (
              <div className="card">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Working Hours Visibility</label>
                    <select
                      value={privacy.workHours}
                      onChange={(e) => handlePrivacyUpdate("workHours", e.target.value)}
                      className="input-field"
                    >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => handlePreferenceUpdate("workingHours", e.target.value)}
                      className="input-field"
                    >
