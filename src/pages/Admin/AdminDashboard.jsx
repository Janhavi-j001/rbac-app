...
const AdminDashboard = () => {
  ...
  const menuItems = [
    { path: "/admin/manage-roles", label: "Manage Roles", icon: "👥" },
    { path: "/admin/manage-permissions", label: "Manage Permissions", icon: "🔐" },
    { path: "/admin/view-logs", label: "View Logs", icon: "📊" },
    { path: "/admin/settings", label: "Settings", icon: "⚙️" },
  ];

  const stats = [
    { label: "Total Users", value: "156", change: "+12%", color: "text-green-600" },
    { label: "Active Projects", value: "24", change: "+8%", color: "text-blue-600" },
    { label: "Permissions", value: "48", change: "+3%", color: "text-purple-600" },
    { label: "System Health", value: "98%", change: "+1%", color: "text-green-600" },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="card">
              ...
              <p className="text-gray-600 mb-6">
                Monitor and manage your organization's access control, user permissions, 
                and system activities from this centralized dashboard.
              </p>
            ...
            <div className="card flex items-center justify-center">
              <div className="text-center">
                ...
                />
                <h3 className="text-lg font-semibold text-primary mb-2">Admin Control Center</h3>
                <p className="text-gray-600">
                  Manage users, roles, and permissions with powerful administrative tools.
                </p>
              </div>
            </div>
          </div>
